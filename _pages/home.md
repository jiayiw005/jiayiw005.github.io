...
- Motifs of Thought (MoT): Reusable Abstractions for Neurosymbolic Reasoning, in collaboration with Chance Jiajie Li *et al.*
...
- Pattern Mining and Automated Tactic Discovery in Lean4 Theorem Proving, advised by [Robert Lewis](https://robertylewis.com/)
...
- Pluggable Analyses for Modern Real Systems, Undergraduate Teaching and Research Awards (UTRA) project advised by [Nikos Vasilakis](https://nikos.vasilak.is/) at [ATLAS Group](http://atlas.cs.brown.edu/)
- Algorithmic Fairness Primer at Socially Responsible Computing (SRC) Handbook [[Handbook]](https://srch.cs.brown.edu), advised by [Suresh Venkatasubramanian](https://dsi.brown.edu/people/suresh-venkatasubramanian) and [Julia Netter](http://www.julianetter.de/) 
- ...

#### Misc

I work for/with a range of community organizations and initiatives: [HOPE Vocational Education Academy](https://www.lncf.cn/edu/item/31.html), [Period Pride](https://ssir.org/articles/entry/ending_period_shame_and_poverty_in_asia), [House of Hope CDC](https://thehouseofhopecdc.org/) (again HOPE!), etc. These engagements continue to shape my understanding of the friction between formal models and on-the-ground complexities. 
